...
public class LispUtil {
	...
	public static void evalExpInPackage (SwankInterface swank,String pack,String exp) {
		swank.sendEval(exp,pack,null);

	}
	public static String formatSwankPackageName (String pack) {
	...
	public static void evalExpInCurrentPackageIf (SwankInterface swank,String exp,
		...
		if (pref) {
			evalExpInCurrentPackage(swank,exp,doc,offset,ret);
			return;
		}
		swank.sendEval(exp,null);
	}
	
	public static void evalExpInCurrentPackage (SwankInterface swank,String exp,IDocument doc,int offset,ReplView.ReturnHandler ret) {
