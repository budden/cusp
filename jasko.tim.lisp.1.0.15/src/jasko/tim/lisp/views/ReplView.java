...
public class ReplView extends ViewPart implements SelectionListener {
	...
	public void createPartControl(Composite parent) {
		...
		if (swank == null || !swank.isConnected()) {
			...
			lbl.setText(swank.getErrorMessage());
	...
	public class ReturnHandler extends SwankRunnable {
		public void run() {
	...
	MouseListener, KeyListener, TreeListener, SelectionListener {
		...
		public void activate() {
			...
			if (message.trim().equalsIgnoreCase("The assertion (PACKAGEP SWANK::P) failed.")) {
